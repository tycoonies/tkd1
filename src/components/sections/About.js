  ...
  return (
    <Section id="about">
      <Container>
        ...
        <SubTextLight>
        A world where you can be anything you want. Build your own castle and prepare your army and join the Kingdom wars. Would you rather explore dungeons, battle world bosses or duel in the arena? Would you rather be a magician, a martial master or maybe a necromancer? There is plenty to do and choose from. Join the journey!
        </SubTextLight>
        <ButtonContainer>
